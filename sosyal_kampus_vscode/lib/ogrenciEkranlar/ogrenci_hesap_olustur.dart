...
import 'package:sosyal_kampus_vscode/ogrenciEkranlar/ogrenci_hesap_olustur_ek.dart';
import 'package:sosyal_kampus_vscode/services/auth.dart';
import 'package:sosyal_kampus_vscode/shared/loading.dart';

class OgrenciHesapOlustur extends StatefulWidget {
  OgrenciHesapOlustur(
  ...
  var isim;
  @override
  _OgrenciHesapOlusturState createState() => _OgrenciHesapOlusturState();
}

enum SingingCharacter { kadin, erkek }

class _OgrenciHesapOlusturState extends State<OgrenciHesapOlustur> {
