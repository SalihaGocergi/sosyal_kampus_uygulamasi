...
class GonderiAyrintiIsletmeci extends StatefulWidget {
  ...
  final Post post;
  final UsersIsletmeci user;
  var hesapGecisi;
  var isim;

  @override
  _GonderiAyrintiIsletmeciState createState() =>
      _GonderiAyrintiIsletmeciState();
}

int sayac = 0;

class _GonderiAyrintiIsletmeciState extends State<GonderiAyrintiIsletmeci> {
  final _dbIsletmeci = AuthService2();
    ...
    return Column(
      ...
      children: [
        ...
        StreamBuilder<List<Yorumlar>>(
          stream:
              DatabaseService2(uid: widget.user.uid, GonderiId: widget.post.id)
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FutureBuilder<dynamic>(
                      future:
                          isletmeciKullaniciBilgi(yorum[index].yorumYapanId),
