...
class IsletmeciHesapOlustur extends StatefulWidget {
  IsletmeciHesapOlustur(
      {Key key, @required this.hesapGecisi, @required this.isim})
      : super(key: key);
  var hesapGecisi;
  var isim;
  @override
  _IsletmeciHesapOlusturState createState() => _IsletmeciHesapOlusturState();
}

class _IsletmeciHesapOlusturState extends State<IsletmeciHesapOlustur> {
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          "Mekan telefon numarası giriniz",
                                  ...
                                  onPressed: () async {
                                    if (_registerFormKey.currentState
                                      ...
                                      try {
                                        ...
                                        searchIndexUploadData(
                                            user, _mekanAdiKontrol.text);
                                        if (user != null) {
                                          HelperFunctions
